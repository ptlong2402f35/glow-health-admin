			...
			<HomeInstructInnerv2>
				...
				<HomeInstructRightv2>
					<HomeInstructRightv2Inner>
						...
						<HomeInstructRightv2ContentWrap>
							<HomeInstructRightv2Title>{TranslateLabels[lang]?.HOME_PAGEV2_TL}</HomeInstructRightv2Title>
							<HomeInstructRightv2Content>
					...
					<HomeInstructRightv2Inner>
						...
						<HomeInstructRightv2ContentWrap>
							<HomeInstructRightv2Title>{TranslateLabels[lang]?.HOME_PAGEV2_GC}</HomeInstructRightv2Title>
							<HomeInstructRightv2Content>
					...
					<HomeInstructRightv2Inner>
						...
						<HomeInstructRightv2ContentWrap>
							<HomeInstructRightv2Title>{TranslateLabels[lang]?.HOME_PAGEV2_CL}</HomeInstructRightv2Title>
							<HomeInstructRightv2Content>
