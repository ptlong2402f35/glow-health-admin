...
import { DataLoaderItem, ListItemElement } from "../data-loader";
import { TypeUser } from "./HomeLoader";

const FilterListStaffHashTagsLoader: DataLoaderItem = {
	path: "/tags/:link",
	loader: async (path: string, params: any, url?: string) => {
		...
		const buildUrl = (pageNum: number) => {
			const baseUrl = `${environments.domainRoot}/${lang}/tags/${params?.link}`;
			const urlParams = new URLSearchParams(url?.split("?")[1] || "");
		...
		return {
			...
			meta: {
				...
				canonical: `${environments.domainRoot}/vi/tags/${params?.link}`,
				hreflang: [
					{ lang: "x-default", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "vi", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "en", url: `${environments.domainRoot}/en/tags/${params?.link}` },
					{ lang: "ko", url: `${environments.domainRoot}/kr/tags/${params?.link}` },
				],
				structuredData: {
							...
							? [
									{
										...
										item: `${environments.domainRoot}/vi/tags/${breadcrumb[2].url}`,
									},
							  ]
							: []),
					],
...
export default FilterListStaffHashTagsLoader;

export const FilterListStaffHashTagsLoaderMuti: DataLoaderItem = {
	path: "/:lang(vi|en|kr|jp|cn)/tags/:link",
	loader: async (path: string, params: any, url?: string) => {
		const lang = params.lang || "vi";
		const apartment = params.apartment;
		let start = new Date();
		...
		if (lang === "vi") {
			...
			meta = {
				...
				ogSiteName: `${rawListStaffHashTags.pageTitle}`,
				canonical: `${environments.domainRoot}/en/tags/${params?.link}`,
				hreflang: [
					{ lang: "x-default", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "vi", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "en", url: `${environments.domainRoot}/en/tags/${params?.link}` },
							...
							? [
									{
										...
										position: 3,
										name: `${breadcrumb[2].label}`,
										item: `${environments.domainRoot}/en/tags/${breadcrumb[2].url}`,
									},
							  ]
							: []),
					],
			...
			meta = {
				...
				ogSiteName: `${rawListStaffHashTags.pageTitle}`,
				canonical: `${environments.domainRoot}/kr/tags/${params?.link}`,
				hreflang: [
					{ lang: "x-default", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "vi", url: `${environments.domainRoot}/vi/tags/${params?.link}` },
					{ lang: "en", url: `${environments.domainRoot}/en/tags/${params?.link}` },
							...
							? [
									{
										...
										position: 3,
										name: `${breadcrumb[2].label}`,
										item: `${environments.domainRoot}/kr/tags/${breadcrumb[2].url}`,
									},
							  ]
							: []),
					],
