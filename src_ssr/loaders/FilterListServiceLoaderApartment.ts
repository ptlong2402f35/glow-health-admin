...
const FilterListServiceApartmentLoader: DataLoaderItem = {
	path: "/dich-vu/:link/toa-nha/:apartment",
	loader: async (path: string, params: any, url?: string) => {
		...
		const [listStaffResult, urlAddressResult] = await Promise.all([
			ListSerrviceAtHomeSSR(PERPAGE.PerPage, Number(page) || 1, params?.link, filterStar, lang, apartment),
		...
		const buildUrl = (pageNum: number) => {
			const baseUrl = `${environments.domainRoot}/${lang}/dich-vu/${params?.link}/toa-nha/${apartment}`;
			const urlParams = new URLSearchParams(url?.split("?")[1] || "");
		...
		return {
			...
			meta: {
				...
				ogType: "website",
				ogUrl: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}`,
				ogSiteName: `${pageTitle}`,
				canonical: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}`,
				hreflang: [
					{
						lang: "x-default",
						url: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}`,
					},
					{ lang: "vi", url: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}` },
					{ lang: "en", url: `${environments.domainRoot}/en/dich-vu/${params?.link}/toa-nha/${apartment}` },
					{ lang: "ko", url: `${environments.domainRoot}/kr/dich-vu/${params?.link}/toa-nha/${apartment}` },
				],
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							item: `${environments.domainRoot}/vi/dich-vu/${breadcrumb[2].url}/toa-nha/${apartment}`,
						},
					],
				},
...
export default FilterListServiceApartmentLoader;

export const FilterListServiceApartmentLoaderMuti: DataLoaderItem = {
	path: "/:lang(vi|en|kr|jp|cn)/dich-vu/:link/toa-nha/:apartment",
	loader: async (path: string, params: any, url?: string) => {
		const lang = params.lang || "vi";
		const apartment = params.apartment;
		let start = new Date();
		...
		if (lang === "vi") {
			...
			meta = {
				...
				ogImage: "https://glowvietnam.com/static/img/PreviewFinal0512.png",
				ogType: "website",
				ogUrl: `${environments.domainRoot}/en/dich-vu/${params?.link}/toa-nha/${apartment}`,
				ogSiteName: `${pageTitle}`,
				canonical: `${environments.domainRoot}/en/dich-vu/${params?.link}/toa-nha/${apartment}`,
				hreflang: [
					{
						lang: "x-default",
						url: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}`,
				...
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							position: 3,
							name: `${breadcrumb[2].label}`,
							item: `${environments.domainRoot}/en/dich-vu/${breadcrumb[2].url}/toa-nha/${apartment}`,
						},
					],
				},
				GlowError: !pageTitle && true,
			...
			meta = {
				...
				ogImage: "https://glowvietnam.com/static/img/PreviewFinal0512.png",
				ogType: "website",
				ogUrl: `${environments.domainRoot}/kr/dich-vu/${params?.link}/toa-nha/${apartment}`,
				ogSiteName: `${pageTitle}`,
				canonical: `${environments.domainRoot}/kr/dich-vu/${params?.link}/toa-nha/${apartment}`,
				hreflang: [
					{
						lang: "x-default",
						url: `${environments.domainRoot}/vi/dich-vu/${params?.link}/toa-nha/${apartment}`,
				...
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							position: 3,
							name: `${breadcrumb[2].label}`,
							item: `${environments.domainRoot}/kr/dich-vu/${breadcrumb[2].url}/toa-nha/${apartment}`,
						},
					],
				},
				GlowError: !pageTitle && true,
