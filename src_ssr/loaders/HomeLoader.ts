...
const HomeLoader: DataLoaderItem = {
	path: "/spa",
	loader: async (path: string, params: any, url?: string) => {
		...
		return {
			...
			meta: {
				...
				ogType: "website",
				ogUrl: `${environments.domainRoot}/vi/spa`,
				// ogSiteName: "Glow - Khám phá hàng nghìn dịch vụ chất lượng, địa điểm uy tín",
				canonical: `${environments.domainRoot}/vi/spa`,
				hreflang: [
					{ lang: "x-default", url: `${environments.domainRoot}/vi/spa` },
					{ lang: "vi", url: `${environments.domainRoot}/vi/spa` },
					{ lang: "en", url: `${environments.domainRoot}/en/spa` },
					{ lang: "ko", url: `${environments.domainRoot}/kr/spa` },
				],
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							item: `${environments.domainRoot}/vi/spa`,
						},
					],
				},
			},
...
export const HomeLoaderMuti: DataLoaderItem = {
	path: "/:lang(vi|en|kr)/spa",
	loader: async (path: string, params: any) => {
		...
		if (lang === "vi") {
				...
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							position: 2,
							name: `${TranslateLabels[lang]?.LOCATION}`,
							item: `${environments.domainRoot}/en/spa`,
						},
					],
				},
			};
			...
			meta = {
				...
				ogImage: "https://glowvietnam.com/static/img/PreviewFinal0512.png",
				ogType: "website",
				ogUrl: `${environments.domainRoot}/kr/spa`,
				// ogSiteName: "Glow - 수천 개의 고품질 서비스와 신뢰할 수 있는 장소를 발견하세요",
				canonical: `${environments.domainRoot}/kr/spa`,
				hreflang: [
					{ lang: "x-default", url: `${environments.domainRoot}/vi/spa` },
					{ lang: "vi", url: `${environments.domainRoot}/vi/spa` },
					{ lang: "en", url: `${environments.domainRoot}/en/spa` },
				...
				structuredData: {
					...
					itemListElement: [
						...
						},
						{
							...
							position: 2,
							name: `${TranslateLabels[lang]?.LOCATION}`,
							item: `${environments.domainRoot}/kr/spa`,
						},
					],
				},
			};
